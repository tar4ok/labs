package com.example.sportclubolimp;
...
public class AddMemberActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void saveMember(){
        ...
        ContentValues contentValuesс = new ContentValues();
        contentValuesс.put(MemberEntry.COLUMN_FIRST_NAME,firstName);
        contentValuesс.put(MemberEntry.COLUMN_LAST_NAME,lastName);
        contentValuesс.put(MemberEntry.COLUMN_SPORT,sport);
        contentValuesс.put(MemberEntry.COLUMN_GENDER,gender);

        if (currentMemberUri == null){
            ContentResolver contentResolver = getContentResolver();
            Uri uri = contentResolver.insert(MemberEntry.CONTENT_URI,contentValuesс);
            ...
            int rowsChanged = getContentResolver().update(currentMemberUri,contentValuesс,null,null);
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        String[] projection ={
                MemberEntry._ID,MemberEntry.COLUMN_FIRST_NAME,MemberEntry.COLUMN_LAST_NAME,MemberEntry.COLUMN_GENDER,MemberEntry.COLUMN_SPORT
        };
        return new CursorLoader(this,
               currentMemberUri,projection,null,null,null
        );
    }
    ...
    private void deleteMember(){
        if (currentMemberUri!=null)
        {
            ...
            if (rowsDeleted ==0){
                ...
                Toast.makeText(this,"Member id delete",Toast.LENGTH_LONG).show();
            }
            finish();
        }
    }
